...
"</li>"  +
  ...
  request.onreadystatechange = function() {
    ...
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (selectedMuseum) {
        var openingHoursText = "<p><li id=\"adressicon\">" +
        ...
        for (var day in selectedMuseum.opening_hours) {
          openingHoursText += "<p>" + day + ": " + selectedMuseum.opening_hours[day] + "</p>";
        }
        listatext.innerHTML += openingHoursText;
  
        var pricesText = "<p><li id=\"adressicon\">" +
        ...
        for (var key in selectedMuseum.pris) {
          pricesText += "<p>" + selectedMuseum.pris[key] + "</p>";
        }
        listatext.innerHTML += pricesText;
      }
    }
  };
...
function showAttractionDetails(item) {
  ...
  var descriptionText = "<p id=\"text\">" + item.text + "</p>";

  var websiteButton = "<p><button onclick=\"window.location.href='" + item.website + "'\">Besök webbplatsen</button></p>";

  listatext.innerHTML += attractionName + addressText + phoneText + descriptionText + websiteButton;
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4 && request.status == 200) {
      ...
      if (selectedMuseum) {
        var openingHoursText = "<div class=open><li id=\"adressicon\"><span class=\"icon\"><img src=\"img/icontime.svg\"></span><span class=\"address\"></span>Öppettider:</li></div>";
        for (var day in selectedMuseum.opening_hours) {
          openingHoursText += "<div class=open>" + day + ": " + selectedMuseum.opening_hours[day] + "</div>";
        }
        listatext.innerHTML += openingHoursText;

        var pricesText = "<p><li id=\"adressicon\"><span class=\"icon\"><img src=\"img/iconprice.svg\"></span><span class=\"address\"></span>Priser:</li></p>";
        for (var key in selectedMuseum.pris) {
          pricesText += "<p>" + selectedMuseum.pris[key] + "</p>";
        }
        listatext.innerHTML += pricesText;
...
function showAttractionDetails(item) {
  ...
  var addressText = "<div id=\"adress\"><li id=\"adressicon\"><span class=\"icon\"><img src=\"img/iconplace.svg\"></span><span class=\"address\">" + item.address + "</span></li></div>";
  var phoneText = "<div id=\"telefonnummer\"><li id=\"adressicon\"><span class=\"icon\"><img src=\"img/iconphone.svg\"></span><span class=\"address\">" + item.phone_number + "</span></li></div>";
  var openingHoursText = "<div id=\"open\"><p><li id=\"adressicon\"><span class=\"icon\"><img src=\"img/icontime.svg\"></span><span class=\"address\"></span>Öppettider:</li></p>";
  var pricesText = "<div id=\"pris\"><p><li id=\"adressicon\"><span class=\"icon\"><img src=\"img/iconprice.svg\"></span><span class=\"address\"></span>Priser:</li></p>";

  var descriptionText = "<div id=\"descriptionName\"><h2>Description:</h2><p id=\"text\">" + item.text + "</p></div>";
  var websiteButton = "<p><button onclick=\"window.location.href='" + item.website + "'\">Besök webbplatsen</button></p>";
